...
| 32  | [WhatsApp Monitoring Phase 0 Baseline](./32-whatsapp-monitoring-baseline.md) | Source-grounded MCP, auth, session, message, filter, persistence, and engine decisions |
| 33  | [WhatsApp Monitoring Threat Model](./33-whatsapp-monitoring-threat-model.md) | Trust boundaries, security invariants, threat analysis, and required negative tests    |
| 34  | [WhatsApp Monitoring Guide](./34-whatsapp-monitoring.md)                     | Connection, enrollment, rules, digests, privacy, testing, migration, and rollback      |
